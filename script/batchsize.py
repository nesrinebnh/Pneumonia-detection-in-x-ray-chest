...
for p in range(20, 33, 2):
	...
	result = utils.trainFcn(model[j],name, e, datagen, x_train, y_train, x_test, y_test, x_val, y_val,p, True)
...
for l in list:
	...
	j +=1
utils.plot_muliplt_line_chart(plt, 'comparing_the_variation_of_validation_accuracy_in_function_of_epochs_by_using_different_batch_sizes', legend_names)