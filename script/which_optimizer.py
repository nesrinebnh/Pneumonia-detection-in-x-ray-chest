#Please to find the chart of this script in charts\comparison\comparing_the_variation_of_validation_accuracy_in_function_of_epochs_by_using_different_optimizers
...
for opt in optimizers:
	...
	#compile the model
	model[j].compile(optimizer = optimizers[j] , loss = 'binary_crossentropy' , metrics = ['accuracy'])
...
for l in list:
	...
	j +=1
utils.plot_muliplt_line_chart(plt, 'comparing_the_variation_of_validation_accuracy_in_function_of_epochs_by_using_different_optimizers', legend_names)